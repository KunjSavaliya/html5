 /*
 * HexGL
 * @author woxxin <https://woxxin.com>
...
bkcore.hexgl.HexGL.prototype.displayScore = function(f, l)
{
	...
	sf != undefined && (sf.href='http://www.facebook.com/sharer.php?s=100'
		...
		+'&p[summary]='+encodeURIComponent('HexGL is a futuristic racing game built by woxxin using HTML5, Javascript and WebGL. Come challenge your friends on this fast-paced 3D game!')
		+'&p[url]='+encodeURIComponent('https://hexgl.woxxin.com')
		+'&p[images][0]='+encodeURIComponent('https://hexgl.woxxin.com/image.png'));
